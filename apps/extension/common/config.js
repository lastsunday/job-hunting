...
export const GITHUB_APP_CLIENT_SECRET =
  '762e843b1d346533626fe2e9362834c30ad1408c';
export const GITHUB_URL_APP_INSTALL_AUTHORIZE =
  'https://github.com/apps/job-hunting-github-app/installations/new';
export const GITHUB_URL_AUTHORIZE = 'https://github.com/login/oauth/authorize';
export const GITHUB_URL_GET_ACCESS_TOKEN =
  'https://github.com/login/oauth/access_token';
export const GITHUB_URL_API = 'https://api.github.com';
export const GITHUB_URL_GET_USER = 'https://api.github.com/user';
export const GITHUB_APP_INSTALL_CALLBACK_URL =
  'https://github.com/lastsunday/job-hunting-github-app/blob/main/INSTALL';
export const URL_GRAPHQL = 'https://api.github.com/graphql';
export const GITHUB_APP_REPO = 'lastsunday/job-hunting-github-app';
export const URL_POST_ISSUES =
  'https://api.github.com/repos/lastsunday/job-hunting-github-app/issues';

export const URL_TRAFFIC_CLONE =
  'https://api.github.com/repos/lastsunday/job-hunting/traffic/clones';
export const URL_TRAFFIC_POPULAR_PATHS =
  'https://api.github.com/repos/lastsunday/job-hunting/traffic/popular/paths';
export const URL_TRAFFIC_POPULAR_REFERRERS =
  'https://api.github.com/repos/lastsunday/job-hunting/traffic/popular/referrers';
export const URL_TRAFFIC_VIEWS =
  'https://api.github.com/repos/lastsunday/job-hunting/traffic/views';
...
export const APP_URL_LATEST_VERSION =
  'https://api.github.com/repos/lastsunday/job-hunting/releases/latest';
...
export const DEFAULT_MAX_MERGE_SIZE = 5000;
...
export const STORAGE_KEY_SQL_EDITOR_STATE = 'STORAGE_KEY_SQL_EDITOR_STATE';
export const STORAGE_KEY_SQL_EDITOR_VALUE = 'STORAGE_KEY_SQL_EDITOR_VALUE';
