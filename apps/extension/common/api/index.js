...
export const JobApi = {
  ...
  jobStatisticGroupByPublishDate: async function (param) {
    const result = await invoke(
      this.jobStatisticGroupByPublishDate.name,
      param,
    );
    return result.data;
  },
  ...
  jobStatisticJobCompanyTagGroupByPlatform: async function (param) {
    const result = await invoke(
      this.jobStatisticJobCompanyTagGroupByPlatform.name,
      param,
    );
    return result.data;
  },
  ...
  jobStatisticJobCompanyTagGroupByCompany: async function (param) {
    const result = await invoke(
      this.jobStatisticJobCompanyTagGroupByCompany.name,
      param,
    );
    return result.data;
  },
...
export const CompanyApi = {
  ...
  companyStatisticGroupByStartDate: async function (param) {
    const result = await invoke(
      this.companyStatisticGroupByStartDate.name,
      param,
    );
    return result.data;
  },
  ...
  companyStatisticGroupByInsurance: async function (param) {
    const result = await invoke(
      this.companyStatisticGroupByInsurance.name,
      param,
    );
    return result.data;
  },
...
export const TaskDataUploadApi = {
  ...
  taskDataUploadGetMaxEndDatetime: async function (param) {
    const result = await invoke(
      this.taskDataUploadGetMaxEndDatetime.name,
      param,
    );
    return result.data;
  },
...
export const DataSharePartnerApi = {
  ...
  dataSharePartnerBatchAddOrUpdate: async function (param) {
    const result = await invoke(
      this.dataSharePartnerBatchAddOrUpdate.name,
      param,
    );
    return result.data;
  },
...
const mockFunction = async (param) => {
