...
const JobTagEdit: React.FC<JobTagEditProps> = ({ data, whitelist, getWhitelistFunction, onSave, mode = "update", validJobId }) => {
    ...
    >
      ...
      >
        ...
        <Form.Item label={null}>
          <Flex justify="end">
            <Space>
              <SubmitButton loading={saveLoading} form={form}>保存</SubmitButton>
            </Space>
          </Flex>
        </Form.Item>
      </Form>
