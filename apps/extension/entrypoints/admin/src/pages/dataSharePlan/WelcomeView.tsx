        ...
        <div className={styles.main}>
            ...
            <div className={styles.descWrapper}>
                ...
                <div className={styles.title}>
                    <div className="i-material-symbols:follow-the-signs-sharp" />可协助你
                </div>
                <div className={styles.item}>
                    <div className="i-material-symbols:counter-1 inline-flex" /> 自动创建数据共享仓库。
                </div>
                <div className={styles.item}>
                    <div className="i-material-symbols:counter-2 inline-flex" /> 定时上传职位，公司，公司标签数据。
                </div>
                <div className={styles.item}>
                    <div className="i-material-symbols:counter-3 inline-flex" /> 定时获取来自小伙伴的共享数据。
                </div>
