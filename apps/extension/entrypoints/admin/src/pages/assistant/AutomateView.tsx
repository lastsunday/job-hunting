...
const AutomateView: React.FC<AutomateProps> = (props) => {
  ...
  const [isMissionLogDetailModalOpen, setIsMissionLogDetailModalOpen] =
    useState(false);
    ...
    <>
      ...
      <Space direction="vertical">
        <Flex gap="small" align="center">
          ...
          <Switch
            checkedChildren="开启排序"
            unCheckedChildren="关闭排序"
            value={isSort}
            onChange={(checked) => {
              setIsSort(checked);
            }}
