...
export function useSiliconflow() {
	...
	const analyze = async ({ url = "https://api.siliconflow.cn", model = "deepseek-ai/DeepSeek-R1-Distill-Llama-8B", hr = defaultHrDesc, demand = '', resume = '', token = '', getResponse = (url: string, bodyString: string): Promise<{ json: () => object }> => {
